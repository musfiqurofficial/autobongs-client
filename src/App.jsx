    ...
    <>
      ...
      >
        ...
        <div className="max-w-full w-full h-screen flex flex-col justify-center items-center text-white px-12 sm:px-[0px]">
          ...
          <button className="my-[40px] text-[18px] sm:text-[24px] font-[500] px-8 py-4 sm:px-[50px] sm:py-[18px] bg-[#5024CE] rounded-xl hover:underline hover:transition hover:duration-150 hover:ease-in-out transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300">
